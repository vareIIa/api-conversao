...
def create_policy_structure(base_path,nome_curso_input):
    policies_path = os.path.join(base_path, 'policies', '2024_T4')
    ...
    # print(f"Arquivo 'policy.json' criado em 'policies/2024_T4'.")
...
def create_grading_policy(base_path):
    ...
    # print(f"Arquivo 'grading_policy.json' criado em 'policies/2024_T4'.")
...
def create_course_xml(base_path):
    ...
    course_content = '''<course url_name="2024_T4" org=".Edu" course="TU104"/>'''
...
{chapters_xml}  <wiki slug="{org}+{random_sigla}+{course_id_ano}"/>
    ...
    '''
                ...
                vertical_content = f'''
    <vertical display_name="{unidade_nome}" parent_url="block-v1:FelipinhoTutoriais+TU01+2024_TU01+type@sequential+block@{unique_id}" index_in_children_list="0">
...
def create_course_api(nome_curso, current_year, org, random_sigla):
    payload = {
        ...
        "enrollment_end": "2024-01-31T23:59:59Z"
    }
